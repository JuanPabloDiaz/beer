<template>
  <div
    class="min-h-screen flex flex-col bg-amber-50 dark:bg-gray-900 transition-colors duration-200"
  >
    <header class="bg-amber-500 dark:bg-amber-800 text-white shadow-md">
      ...
      >
        ...
        <nav class="hidden md:flex items-center space-x-6">
          ...
          <NuxtLink
            to="/breweries/random"
            class="hover:text-amber-200 transition-colors"
            >Random Brewery</NuxtLink
          >
          <NuxtLink to="/search" class="hover:text-amber-200 transition-colors"
            >Search</NuxtLink
          >
          <NuxtLink
            to="/metadata"
      ...
      <div v-show="isMenuOpen" class="md:hidden bg-amber-600 dark:bg-amber-900">
        <div class="container mx-auto px-4 py-2 flex flex-col space-y-2">
          <NuxtLink
            to="/breweries"
            class="py-2 hover:text-amber-200 transition-colors"
          ...
          <button
            @click="toggleDarkMode"
            class="flex items-center py-2 hover:text-amber-200 transition-colors"
          >
            <span class="mr-2">{{
      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <div class="mb-4 md:mb-0">
            ...
            <p class="text-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                class="font-medium underline hover:text-amber-100"
                >OpenBreweryDB</a
              >
            </p>
          </div>
          <div class="flex space-x-4">
            ...
            <a
              href="https://github.com/juanpablodiaz/beer"
