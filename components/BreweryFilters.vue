<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <!-- Type Filter -->
      <div class="space-y-2">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Brewery Type</label>
        <select 
    ...
    <div class="mt-6 flex flex-col md:flex-row md:items-center justify-between">
      ...
      <div class="flex items-center">
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300 mr-2">Per page:</label>
        <select 
