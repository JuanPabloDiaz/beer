<template>
  <div>
    ...
    <div class="mb-6">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Random Brewery</h1>
      <p class="text-gray-600 dark:text-gray-400">Discover a new brewery at random. Feeling lucky?</p>
    </div>
    ...
    <div v-else-if="error" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
      ...
      <button @click="fetchRandomBrewery" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-md transition-colors">
        Try Again
      </button>
    </div>
